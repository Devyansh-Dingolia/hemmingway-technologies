...
const SOLUTIONS = [
  {
    ...
    features: ['Full-stack web applications', 'Enterprise resource planning', 'Workflow automation tools', 'Data pipeline engineering'],
    accent: '#6367f1',
  },
  {
    id: 'ai-ml',
    ...
    features: ['LLM integration & fine-tuning', 'Predictive analytics', 'Computer vision systems', 'Natural language processing'],
    accent: '#a78bfa',
  },
  {
    id: 'cloud',
    ...
    features: ['Cloud migration & strategy', 'Kubernetes & container orchestration', 'CI/CD pipeline design', 'Infrastructure as code'],
    accent: '#38bdf8',
  },
  {
    id: 'cybersecurity',
    ...
    features: ['Security architecture design', 'Penetration testing', 'Compliance frameworks', 'Incident response planning'],
    accent: '#f43f5e',
  },
  {
    id: 'mobile-web',
    ...
    features: ['Progressive web apps', 'Cross-platform mobile development', 'UI/UX design & prototyping', 'Performance optimization'],
    accent: '#22c55e',
  },
  {
    id: 'api-integrations',
    ...
    features: ['RESTful & GraphQL API design', 'Third-party integrations', 'Legacy system modernization', 'Event-driven architecture'],
    accent: '#f59e0b',
  },
];
